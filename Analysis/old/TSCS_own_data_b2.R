...
# 
# TSCS_data_trans = TSCS_data %>% 
#   filter(country_name %in% Pop_Countries) %>% 
#   mutate(classification_context = ifelse(country_name == "Mexico" & year < 2000, "", classification_context),
...
# 
# # Government
# TSCS_reg = function(variable, lag=1) {
#   if (lag == 1) {
...
# 
# TSCS_reg("decision_freedom_context", lag=1)
# TSCS_reg("decision_equality_context", lag=1)
# TSCS_reg("decision_control_context", lag=1)
# 
# TSCS_reg("intermediate_freedom_context", lag=1)
...
# TSCS_reg("communication_equality_context", lag=2)
# TSCS_reg("communication_control_context", lag=1)
# 
# TSCS_reg("rights_freedom_context", lag=2)
# TSCS_reg("rights_equality_context", lag=1)
# TSCS_reg("rights_control_context", lag=2)
# 
# TSCS_reg("rule_settlement_freedom_context", lag=1)
...
# 
# 
# int_f = TSCS_reg_brms("intermediate_freedom_context", lag=1)
# int_e = TSCS_reg_brms("intermediate_equality_context", lag=1)
# int_c = TSCS_reg_brms("intermediate_control_context", lag=1)
# 
# com_f = TSCS_reg_brms("communication_freedom_context", lag=1)
# com_e = TSCS_reg_brms("communication_equality_context", lag=2)
# com_c = TSCS_reg_brms("communication_control_context", lag=1)
# 
# 
# # saveRDS(rights_f, file="brmsModels/rights_f.RDS")
# # rights_f = readRDS(file="brmsModels/rights_f.RDS")
# 
# rights_f = TSCS_reg_brms("rights_freedom_context", lag=1)
# rights_e = TSCS_reg_brms("rights_equality_context", lag=1)
# rights_c = TSCS_reg_brms("rights_control_context", lag=1)
# 
...
# 
# rs_f = TSCS_reg_brms("rule_settlement_freedom_context", lag=1)
# rs_e = TSCS_reg_brms("rule_settlement_equality_context", lag=1)
# rs_c = TSCS_reg_brms("rule_settlement_control_context", lag=1)
# 
...
# model = rs_c 
# effect = 0.3
# lagvar = "rule_settlement_control_context_wi_lag" 
# lagvar2 = NULL
# summary(model$data)
# 
# coef(model)$country_name[,, "Intercept"]
# coef(model)$year[,, "Intercept"]
# hist(model$data$decision_freedom_context_wi_lag)
# hist(model$data$decision_freedom_context)
# brms_ml_data$rule_settlement_control_context
# test = brms_ml_data %>% 
#   select(country_name, year, rule_settlement_control_context, 
#          rule_settlement_control_context_lag, 
#          rule_settlement_control_context_wi_lag, 
#          rule_settlement_control_context_wi_lag_lag2, 
#          classification_context,
#          
#          pop_HOG_caus_wi,
#          pop_HOG_caus_cbw,
#          pop_HOG_caus_ybw,
#          rule_settlement_control_context_lag_depcbw, rule_settlement_control_context_lag_depybw)
# upper = T
# upper = F
# 
...
# 
# 
# testu = get_prediction(dec_f, 1, "decision_freedom_context_wi_lag", upper=T, cred=0.9, time = 9) %>% 
#   mutate(Scen = "upper") 
# 
# testl = get_prediction(dec_f, -1, "decision_freedom_context_wi_lag", upper=F, cred=0.9, time = 9) %>% 
#   mutate(Scen = "lower") 
# 
# testu %>% 
#   bind_rows(testl) %>% 
...
# 
# 
# testu = get_prediction(dec_e, 0.3, "decision_equality_context_lag", "decision_equality_context_lag2") %>% 
#   mutate(Scen = "upper") 
# 
# testl = get_prediction(dec_e, -0.3, "decision_equality_context_lag", "decision_equality_context_lag2") %>% 
#   mutate(Scen = "lower") 
# 
# testu %>% 
#   bind_rows(testl) %>% 
...
# 
# 
# testu = get_prediction(dec_c, 1, "decision_control_context_lag") %>% 
#   mutate(Scen = "upper") 
# 
# testl = get_prediction(dec_c, 0, "decision_control_context_lag") %>% 
#   mutate(Scen = "lower") 
# 
# testu %>% 
#   bind_rows(testl) %>% 
...
# 
# 
# testu = get_prediction(rs_f, 1, "rule_settlement_freedom_context_wi_lag", upper=T) %>% 
#   mutate(Scen = "upper") 
# 
# testl = get_prediction(rs_f, 0, "rule_settlement_freedom_context_wi_lag", upper=F) %>% 
#   mutate(Scen = "lower") 
# 
# testu %>% 
#   bind_rows(testl) %>% 
...
# 
# 
# testu = get_prediction(rs_c, 1, "rule_settlement_control_context_wi_lag", upper=T, cred=0.9) %>% 
#   mutate(Scen = "upper") 
# 
# testl = get_prediction(rs_c, 0, "rule_settlement_control_context_wi_lag", upper=F, cred=0.9) %>% 
#   mutate(Scen = "lower") 
# 
# testu %>% 
#   bind_rows(testl) %>% 
